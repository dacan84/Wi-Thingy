...
#define MS5540B_H_
	...
	#define MSB_DIN		IOPORT_CREATE_PIN(PORTA, PINA3)	   /* Data in sensor pin */
	#define MSB_DOUT	IOPORT_CREATE_PIN(PORTA, PINA5)	   /* Data out sensor pin */
	#define MSB_SCLK	IOPORT_CREATE_PIN(PORTA, PINA6)	   /* Clk pin */
...
void Ms5540Measure(void);

void Ms5540Calculate(MsData msData);
